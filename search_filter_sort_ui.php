    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (recordsBtn && analyticsBtn && recordsView && analyticsView) {
            ...
            analyticsBtn.addEventListener('click', function() {
                ...
                // Important: Initialize charts after the view is visible
                setTimeout(function() {
                    if (typeof initializeAnalytics === 'function') {
                        ...
                        if (document.getElementById('timeChart') && typeof Chart !== 'undefined') {
                            console.log("Trying direct chart initialization");
                            // Simple chart initialization code here
                        }
                    }
                }, 100);
            });
